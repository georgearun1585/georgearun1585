<#
.SYNOPSIS
    This PowerShell script ensures that Bluetooth must be turned off unless approved by the organization.
...
Write-Host "Checking Bluetooth policy..." -ForegroundColor Cyan
